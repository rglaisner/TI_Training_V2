# SCHEMA DESIGN - Profiles and Events Collections

Here is the TypeScript schema design for the Profiles and Events collections, specifically expanded to handle the new categories (Leading & Managing, Creative & Critical Thinking, Thought Leadership).
...
## Profile Document Schema (Firestore /profiles Collection)
...
interface UserProfile {
  userId: string;
  tenantId: string; // Enforces strict enterprise data segregation
...
## Anonymized Event Log (Firestore /events Collection)
