    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="mx-auto max-w-5xl p-6">
        <header className="border-b border-zinc-800 pb-4">
          <h1 className="text-2xl font-semibold tracking-tight">TIC Trainer V2</h1>
        ...
        {missionState ? (
          <section className="mt-4 grid gap-4 md:grid-cols-2">
            <article data-testid="narrative-region" className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-4 md:col-span-2">
              ...
              <p data-testid="scene-text" className="mt-3 whitespace-pre-line text-zinc-300 leading-relaxed">
